                        ...
                        <div class="col-md-9">
                            ...
                            <div class="card">
                                <div class="card-header p-2">
                                    <legend class="text-center">Update Carrier</legend>
                                </div>
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="activity">
                                            ...
                                            <form class="form-horizontal" method="POST"
                                                action="{{ route('admin#updateCarrier', $carrier->carrier_id) }}">
                                                @csrf
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" placeholder=""
                                                            name='phone' value="{{ old('phone', $carrier->phone) }}">
                                                        @if ($errors->has('phone'))
                                                ...
                                                <div class="form-group row">
                                                    <div class="offset-sm-2 col-sm-10">
                                                        <button type="submit"
                                                            class="btn bg-dark text-white float-right">Update</button>
                                                    </div>
                                                </div>
                                            </form>
                                            {{-- form end --}}
